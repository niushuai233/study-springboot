...
import cc.niushuai.study.springboot.mybaits.entity.SysLog;
import cc.niushuai.study.springboot.mybaits.utils.IPUtil;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(cc.niushuai.study.springboot.mybaits.annotation.Log)")
    public void log() {
    }
